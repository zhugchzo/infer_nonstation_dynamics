...
for dt in [0.02,0.03,0.04,0.05]:
    ...
    if not os.path.exists('Koscillators_data_interval/{}'.format(dt)):
        os.makedirs('Koscillators_data_interval/{}'.format(dt))
    ...
    for rand_seed in range(100):
        ...
        df_data.to_csv('Koscillators_data_interval/{}/Koscillators_data_{}.csv'.format(dt,rand_seed),index=False)