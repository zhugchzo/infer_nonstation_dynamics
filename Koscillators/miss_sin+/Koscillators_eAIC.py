...
for rand_seed in range(100):
    ...
    dic_W_out.to_csv('../../results/Koscillators/miss_sin+/Koscillators_W_out_{}.csv'.format(rand_seed),header=True,index=False)
    ...
    pred_out.to_csv('../../results/Koscillators/miss_sin+/Koscillators_pred_{}.csv'.format(rand_seed),header = True, index=False)
