...
class ReservoirComputing:
    ...
    def multi_step_predict(self, X_start, num_steps, t_series):
        ...
        for t in range(num_steps):
            ...
            current_input = np.concatenate((last_x.reshape(-1), t_series[t]))  # 输入是 x(t) 和 t(t)
...
for rand_seed in range(100):
    ...
    pred_out.to_csv('../../results/Koscillators/competing/Koscillators_pred_RCt_{}.csv'.format(rand_seed),header = True, index=False)