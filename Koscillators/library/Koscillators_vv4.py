...
dnonlin = dnonlin_2 + dnonlin_3 + dnonlin_4
...
for tl in [300, 350, 400, 450, 500]:
    ...
    if not os.path.exists('../../results/Koscillators/library4/{}'.format(tl)):
        os.makedirs('../../results/Koscillators/library4/{}'.format(tl))
    ...
    for rand_seed in range(100):
        ...
        dic_W_out.to_csv('../../results/Koscillators/library4/{}/Koscillators_W_out_{}.csv'.format(tl,rand_seed),header=True,index=False)
