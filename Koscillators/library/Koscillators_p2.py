...
for tl in [300, 350, 400, 450, 500]:
    ...
    if not os.path.exists('../../results/Koscillators/library2/{}'.format(tl)):
        os.makedirs('../../results/Koscillators/library2/{}'.format(tl))
    ...
    for rand_seed in range(100):
        ...
        dic_W_out.to_csv('../../results/Koscillators/library2/{}/Koscillators_W_out_p_{}.csv'.format(tl,rand_seed),header=True,index=False)
