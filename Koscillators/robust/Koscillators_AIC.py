...
if not os.path.exists('../../results/Koscillators/robust'):
    os.makedirs('../../results/Koscillators/robust')
...
for rand_seed in range(100):
    ...
    dic_W_out.to_csv('../../results/Koscillators/robust/Koscillators_W_out_AIC_{}.csv'.format(rand_seed),header=True,index=False)
    ...
    pred_out.to_csv('../../results/Koscillators/robust/Koscillators_pred_AIC_{}.csv'.format(rand_seed),header = True, index=False)