...
for rand_seed in range(100):
    ...
    dic_W_out.to_csv('../../results/Koscillators/robust/Koscillators_W_out_t_{}.csv'.format(rand_seed),header=True,index=False)
    ...
    pred_out.to_csv('../../results/Koscillators/robust/Koscillators_pred_t_{}.csv'.format(rand_seed),header = True, index=False)