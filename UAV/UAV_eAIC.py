...
AIC_out.to_csv('../results/UAV/UAV_AIC.csv', index_label='')
...
df_f_elements.to_csv('../results/UAV/UAV_W_out.csv',header = True)
...
csv_out.to_csv('../results/UAV/UAV_pred.csv',header = True)
...
csv_out.to_csv('../results/UAV/UAV_gen.csv',header = True)