...
df_tseries = pd.read_csv('chick_data_230.csv')
...
AIC_out.to_csv('../results/chick/chick_230_AIC.csv', index_label='')
...
dic_W_out.to_csv('../results/chick/chick_230_W_out.csv',header=True,index=False)
...
pred_1_out.to_csv('../results/chick/chick_230_pred_1.csv',header = True, index=False)
pred_2_out = pd.DataFrame(dic_pred_2)
pred_2_out.to_csv('../results/chick/chick_230_pred_2.csv',header = True, index=False)
...
gen_out.to_csv('../results/chick/chick_230_gen.csv',header = True, index=False)