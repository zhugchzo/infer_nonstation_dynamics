...
AIC_out.to_csv('../results/chick/chick_220_AIC_AIC.csv', index_label='')
...
dic_W_out.to_csv('../results/chick/chick_220_W_out_AIC.csv',header=True,index=False)
...
if pd_bif_time != 0:
    ...
    pred_2_out.to_csv('../results/chick/chick_220_pred_2_AIC.csv',header = True, index=False)
...
pred_1_out.to_csv('../results/chick/chick_220_pred_1_AIC.csv',header = True, index=False)
...
gen_out.to_csv('../results/chick/chick_220_gen_AIC.csv',header = True, index=False)