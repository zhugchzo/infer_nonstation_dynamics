...
dic_W_out.to_csv('../results/chick/chick_335_W_out_t.csv',header=True,index=False)
...
if pd_bif_time != 0:
    ...
    pred_2_out.to_csv('../results/chick/chick_335_pred_2_t.csv',header = True, index=False)
...
pred_1_out.to_csv('../results/chick/chick_335_pred_1_t.csv',header = True, index=False)
...
gen_out.to_csv('../results/chick/chick_335_gen_t.csv',header = True, index=False)