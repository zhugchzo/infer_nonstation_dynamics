...
df_tseries = pd.read_csv('chick_data_220.csv')
...
AIC_out.to_csv('../results/chick/chick_220_AIC.csv', index_label='')
...
dic_W_out.to_csv('../results/chick/chick_220_W_out.csv',header=True,index=False)
...
pred_1_out.to_csv('../results/chick/chick_220_pred_1.csv',header = True, index=False)
pred_2_out = pd.DataFrame(dic_pred_2)
pred_2_out.to_csv('../results/chick/chick_220_pred_2.csv',header = True, index=False)

# generation

# create a place to store feature vectors for prediction
out_gen = np.ones(dtot + cte)               # full feature vector
x_gen = np.zeros((dlin,pd_bif_time+1))      # linear part

x_gen[-1,:] = x_theta_tseries[:pd_bif_time+1,-1]
...
gen_out.to_csv('../results/chick/chick_220_gen.csv',header = True, index=False)