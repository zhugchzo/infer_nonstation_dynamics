...
if not os.path.exists('../results/NED/chick_230'):
    os.makedirs('../results/NED/chick_230')
...
df_pred = pd.read_csv('../results/chick/chick_230_pred_1.csv')
df_pred_AIC = pd.read_csv('../results/chick/chick_230_pred_1_AIC.csv')
df_pred_t = pd.read_csv('../results/chick/chick_230_pred_1_t.csv')

df_gen = pd.read_csv('../results/chick/chick_230_gen.csv')
df_gen_AIC = pd.read_csv('../results/chick/chick_230_gen_AIC.csv')
df_gen_t = pd.read_csv('../results/chick/chick_230_gen_t.csv')
...
dic_pred.to_csv('../results/NED/chick_230/chick_230_pred.csv',header = True)

dic_pred_AIC = pd.DataFrame(dic_pred_AIC)
dic_pred_AIC.to_csv('../results/NED/chick_230/chick_230_pred_AIC.csv',header = True)

dic_pred_t = pd.DataFrame(dic_pred_t)
dic_pred_t.to_csv('../results/NED/chick_230/chick_230_pred_t.csv',header = True)
...
dic_gen.to_csv('../results/NED/chick_230/chick_230_gen.csv',header = True)

dic_gen_AIC = pd.DataFrame(dic_gen_AIC)
dic_gen_AIC.to_csv('../results/NED/chick_230/chick_230_gen_AIC.csv',header = True)

dic_gen_t = pd.DataFrame(dic_gen_t)
dic_gen_t.to_csv('../results/NED/chick_230/chick_230_gen_t.csv',header = True)
