...
for al in [0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8, 2]:
    for bl in [4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5]:
        ...
        file_path = '../results/cusp/library4/prediction/cusp_pred_{}_{}.csv'.format(al, bl)
...
for al in [0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8, 2]:
    for bl in [4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5]:
        ...
        file_path_ab = '../results/cusp/library4/prediction/cusp_pred_ab_{}_{}.csv'.format(al, bl)
...
for al in [0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8, 2]:
    for bl in [4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5]:
        ...
        file_path_t = '../results/cusp/library4/prediction/cusp_pred_t_{}_{}.csv'.format(al, bl)
...
whisker_min_bif_error_ab = lower_bound_bif_error_ab
whisker_max_bif_error_ab = upper_bound_bif_error_ab
...
whisker_min_NED_ab = lower_bound_NED_ab
whisker_max_NED_ab = upper_bound_NED_ab
