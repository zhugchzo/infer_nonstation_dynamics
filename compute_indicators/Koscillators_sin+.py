...
for rand_seed in range(100):
    ...
    df_pred = pd.read_csv('../results/Koscillators/miss_sin+/Koscillators_pred_{}.csv'.format(rand_seed))
    df_pred_p = pd.read_csv('../results/Koscillators/miss_sin+/Koscillators_pred_p_{}.csv'.format(rand_seed))
    df_pred_t = pd.read_csv('../results/Koscillators/miss_sin+/Koscillators_pred_t_{}.csv'.format(rand_seed))
...
NED_out.to_csv('../results/NED/Koscillators_NED_miss_sin+.csv',header = True, index=False)