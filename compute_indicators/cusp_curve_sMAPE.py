...
for ii in range(100):
    ...
    df_W_out = pd.read_csv('../results/cusp/cusp_curve/cusp_curve_W_out_{}.csv'.format(ii))
    df_W_out_ab = pd.read_csv('../results/cusp/cusp_curve/cusp_curve_W_out_ab_{}.csv'.format(ii))
    df_W_out_t = pd.read_csv('../results/cusp/cusp_curve/cusp_curve_W_out_t_{}.csv'.format(ii))
    df_W_out_AIC = pd.read_csv('../results/cusp/cusp_curve/cusp_curve_W_out_AIC_{}.csv'.format(ii))

    df_ab = pd.read_csv('../cusp/cusp_curve_data/cusp_curve_data_{}.csv'.format(ii))
...
smape_out.to_csv('../results/sMAPE/cusp_curve_smape.csv',header = True, index=False)
