...
df_tseries = pd.read_csv('cusp_sin_data_{}_{}.csv'.format(al,bl))
...
dic_W_out.to_csv('../results/cusp/cusp_sin_W_out_{}_{}.csv'.format(al,bl),header=True,index=False)
...
pred_out.to_csv('../results/cusp/cusp_sin_pred_{}_{}.csv'.format(al,bl),header = True, index=False)
