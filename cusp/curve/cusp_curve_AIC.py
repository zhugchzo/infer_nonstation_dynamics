...
if not os.path.exists('../../results/cusp/cusp_curve'):
    os.makedirs('../../results/cusp/cusp_curve')
...
for curve in range(100):
    ...
    df_tseries = pd.read_csv('../cusp_curve_data/cusp_curve_data_{}.csv'.format(curve))
    ...
    dic_W_out.to_csv('../../results/cusp/cusp_curve/cusp_curve_W_out_AIC_{}.csv'.format(curve),header=True,index=False)
    ...
    pred_out.to_csv('../../results/cusp/cusp_curve/cusp_curve_pred_AIC_{}.csv'.format(curve),header = True, index=False)