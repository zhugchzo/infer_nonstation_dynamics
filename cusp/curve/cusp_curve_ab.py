...
for curve in range(100):
    ...
    dic_W_out.to_csv('../../results/cusp/cusp_curve/cusp_curve_W_out_ab_{}.csv'.format(curve),header=True,index=False)
    ...
    pred_out.to_csv('../../results/cusp/cusp_curve/cusp_curve_pred_ab_{}.csv'.format(curve),header = True, index=False)