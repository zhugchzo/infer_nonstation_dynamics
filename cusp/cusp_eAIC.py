...
df_tseries = pd.read_csv('cusp_data.csv')
...
AIC_out.to_csv('../results/cusp/cusp_AIC.csv', index_label='')
...
dic_W_out.to_csv('../results/cusp/cusp_W_out.csv',header=True,index=False)
...
pred_out.to_csv('../results/cusp/cusp_pred.csv',header = True, index=False)
