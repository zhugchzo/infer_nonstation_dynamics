...
polynomial = ['cte', 'x', 'a', 'b', 'x^2', 'ax', 'bx', 'a^2', 'ab', 'b^2', 'x^3', 'ax^2', 'bx^2', 'a^2x', 'abx', 'b^2x', 'a^3', 'a^2b', 'ab^2', 'b^3',
              ...
              'x^5', 'ax^4', 'bx^4', 'a^2x^3', 'abx^3', 'b^2x^3', 'a^3x^2', 'a^2bx^2', 'ab^2x^2', 'b^3x^2', 'a^4x', 'a^3bx', 'a^2b^2x', 'ab^3x', 'b^4x','a^5', 'a^4b', 'a^3b^2', 'a^2b^3', 'ab^4', 'b^5',
              'x^6', 'ax^5', 'bx^5', 'a^2x^4', 'abx^4', 'b^2x^4', 'a^3x^3', 'a^2bx^3', 'ab^2x^3', 'b^3x^3', 'a^4x^2', 'a^3bx^2', 'a^2b^2x^2', 'ab^3x^2', 'b^4x^2','a^5x', 'a^4bx', 'a^3b^2x', 'a^2b^3x', 'ab^4x', 'b^5x',
...
for tl in [500, 550, 600, 650, 700]:
    ...
    for al in [0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8, 2]:
        for bl in [4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5]:
            ...
            dic_W_out.to_csv('../../results/cusp/library6/{}/cusp_W_out_ab_{}_{}.csv'.format(tl,al,bl),header=True,index=False)
