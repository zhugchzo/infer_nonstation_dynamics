...
if not os.path.exists('../../results/cusp/robust'):
    os.makedirs('../../results/cusp/robust')
...
for al in [0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8, 2]:
    for bl in [4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5]:
        ...
        dic_W_out.to_csv('../../results/cusp/robust/cusp_W_out_AIC_{}_{}.csv'.format(al,bl),header=True,index=False)
        ...
        pred_out.to_csv('../../results/cusp/robust/cusp_pred_AIC_{}_{}.csv'.format(al,bl),header = True, index=False)
