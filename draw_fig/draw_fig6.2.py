...
ax6.text(-0.16, 1.1,'d',ha='left', transform=ax6.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
plt.subplots_adjust(top=0.97, bottom=0.09, left=0.04, right=0.98, hspace=0.3, wspace=0.3)
plt.savefig('../figures/FIG6.2.pdf',format='pdf')
plt.savefig('/Users/zhugchzo/Desktop/3paper_fig/FIG6.2.png',format='png',dpi=600)