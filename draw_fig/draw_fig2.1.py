...
ax1.text(-0.16, 1.1,'a',ha='left', transform=ax1.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
#            loc='center',bbox_to_anchor=(0.49, 0.85),frameon=False, markerscale=2, prop={'size':12})

ax6.set_title('300 data points',fontdict=font_title)
ax6.text(-0.16, 1.1,'b',ha='left', transform=ax6.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
plt.subplots_adjust(top=0.9, bottom=0.07, left=0.04, right=0.98, hspace=0.25, wspace=0.3)
plt.savefig('../figures/FIG2.1.pdf',format='pdf')
plt.savefig('/Users/zhugchzo/Desktop/3paper_fig/FIG2.1.png',format='png',dpi=600)