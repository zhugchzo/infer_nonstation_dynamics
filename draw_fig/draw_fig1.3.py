...
ax4.text(0.3,0.3,'Surrogate model :',fontdict={'family':'Arial','size':20,'weight':'medium'},color='royalblue')
...
ax4.text(-0.12, 1.02,'c',ha='left', transform=ax4.transAxes,fontdict={'family':'Arial','size':40,'weight':'bold'})
...
plt.savefig('../figures/FIG1.3.pdf',format='pdf')
plt.savefig('/Users/zhugchzo/Desktop/3paper_fig/FIG1.3.png',format='png',dpi=600)