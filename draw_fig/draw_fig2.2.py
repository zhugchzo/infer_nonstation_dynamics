...
fig, axs = plt.subplots(1, 5, figsize=(15,4.5))
...
ax1.set_ylabel('Fraction of bifurcation',font_y)

ax1.text(-0.25, 1.2,'c',ha='left', transform=ax1.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
ax4.text(-0.25, 1.2,'d',ha='left', transform=ax4.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
plt.subplots_adjust(top=0.7, bottom=0.15, left=0.05, right=0.98, wspace=0.35)

fig.text(0.3, 0.9, 'Cusp bifurcation', ha='center', va='center',fontsize=20,fontname='Arial',color='navy')
fig.text(0.8, 0.9, 'Kuramoto oscillators', ha='center', va='center',fontsize=20,fontname='Arial',color='navy')
...
plt.savefig('../figures/FIG2.2.pdf',format='pdf')
plt.savefig('/Users/zhugchzo/Desktop/3paper_fig/FIG2.2.png',format='png',dpi=600)