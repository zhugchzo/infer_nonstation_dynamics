...
# df_chick_270
df_chick_270_AIC = pd.read_csv('../results/chick/chick_270_AIC.csv', header=None)

chick_270_AIC = df_chick_270_AIC.to_numpy()[1:,1:] # shape = (11,12)

chick_270_AIC_filtered = chick_270_AIC[chick_270_AIC != 1e5]
max_value_chick_270 = np.max(chick_270_AIC_filtered)
chick_270_AIC[chick_270_AIC == 1e5] = max_value_chick_270
...
# ax5
heatmap = sns.heatmap(chick_270_AIC,
            cmap='PuBu',
            linewidths=0.005, 
            linecolor='silver',
            annot=False,
...
ax5.scatter(5+0.5, 4+0.5, color='blueviolet', s=150, marker=(5, 1))
...
cbar = heatmap.collections[0].colorbar
cbar.set_ticks([-6e14, -3e14])
cbar.set_ticklabels(['-6', '-3'])
cbar.ax.text(0.8, -9e14, r'$10^{14}$', ha='center', va='top', fontsize=10, fontproperties=font)
cbar.ax.text(3.2, -0.4e14, r'$\epsilon$AIC', ha='center', va='top', fontsize=14, fontproperties=font)
cbar.ax.tick_params(length=0)
for label in cbar.ax.get_yticklabels():
    label.set_fontproperties(font)
    label.set_fontsize(12)
