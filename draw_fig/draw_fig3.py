...
ax6.text(-0.18, 1,'F',ha='left', transform=ax6.transAxes,fontdict={'family':'Arial','size':22,'weight':'bold'})
...
ax7.text(-0.18, 1,'G',ha='left', transform=ax7.transAxes,fontdict={'family':'Arial','size':22,'weight':'bold'})
...
ax8.text(-0.18, 1,'H',ha='left', transform=ax8.transAxes,fontdict={'family':'Arial','size':22,'weight':'bold'})
