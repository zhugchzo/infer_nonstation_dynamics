...
ax2.fill_between(train_UAV_x, train_UAV_y-0.05, train_UAV_y+0.05, color='silver', alpha=0.9, linewidth=0, zorder=1)
...
ax2.set_xlabel('X Position (m)',font_x,labelpad=0)
ax2.set_ylabel('Y Position (m)',font_y,labelpad=-15)
ax2.set_xlim(-1,11.5)
ax2.set_xticks([0,6,10])
