...
ax2.scatter(gen_UAV_x[::2],gen_UAV_y[::2],s=50,marker='o',facecolors='none',edgecolors='darkorange',zorder=3)
...
chick_270_t2 = df_chick_270_pred_2['Time']

ibi = df_chick_270_tseries['IBI (s)']
gen_ibi = df_chick_270_gen['gen']
...
ax6.scatter(chick_270_t1[1:1+len(gen_ibi)][::2],gen_ibi[::2],s=50,marker='o',facecolors='none',edgecolors='darkorange',zorder=3)
ax6.scatter(chick_270_t2,pred_ibi_2,s=50,marker='o',facecolors='none',edgecolors='darkorange',zorder=3)
...
ax6.set_xlim(-13,283)
ax6.set_xticks([0,270])
ax6.set_ylim(0.3,1.8)
ax6.set_yticks([0.4,1.7])
ax6.set_yticklabels(['0.4','1.7'])
