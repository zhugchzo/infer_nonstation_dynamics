...
ax1.text(-0.25, 1.2,'a',ha='left', transform=ax1.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})

ax1.text(-0.25, -0.35,'c',ha='left', transform=ax1.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
ax2.set_ylabel('Bifurcation point inaccuracy (timepoint)',font_y)
...
ax4.text(-0.25, 1.2,'b',ha='left', transform=ax4.transAxes,fontdict={'family':'Arial','size':30,'weight':'bold'})
...
plt.subplots_adjust(top=0.7, bottom=0.2, left=0.05, right=0.98, wspace=0.35)
...
plt.savefig('../figures/FIG6.1.pdf',format='pdf')
plt.savefig('/Users/zhugchzo/Desktop/3paper_fig/FIG6.1.png',format='png',dpi=600)