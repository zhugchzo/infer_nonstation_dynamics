...
# df for ax5
df_chick_270_gen_ned = pd.read_csv('../results/NED/chick_270/chick_270_gen.csv')
df_chick_270_gen_ned_t = pd.read_csv('../results/NED/chick_270/chick_270_gen_t.csv')
df_chick_270_gen_ned_AIC = pd.read_csv('../results/NED/chick_270/chick_270_gen_AIC.csv')
...
# ax5
chick_270_gen_ned = df_chick_270_gen_ned[['normal_Eucli_d']].values
chick_270_gen_ned_t = df_chick_270_gen_ned_t[['normal_Eucli_d']].values
chick_270_gen_ned_AIC = df_chick_270_gen_ned_AIC[['normal_Eucli_d']].values

len_ax5 = len(chick_270_gen_ned)
t_ax5 = np.arange(0,len_ax5)
len_ax5_t = len(chick_270_gen_ned_t)
t_ax5_t = np.arange(0,len_ax5_t)
len_ax5_AIC = len(chick_270_gen_ned_AIC)
t_ax5_AIC = np.arange(0,len_ax5_AIC)

ned_ax5 = chick_270_gen_ned[:,0]
ned_t_ax5 = chick_270_gen_ned_t[:,0]
ned_AIC_ax5 = chick_270_gen_ned_AIC[:,0]
...
ax5.axvline(x=221, color='chocolate', linestyle='--', linewidth=1.5, zorder=0,alpha=0.9)

ax5.annotate('period-2',xy=(220, 0.3),xytext=(110, 0.33),fontsize=16,color='chocolate',
             arrowprops=dict(arrowstyle='->',color='chocolate',lw=1))

ax5.set_xlim(-13,283)
ax5.set_xticks([0,135,270])
