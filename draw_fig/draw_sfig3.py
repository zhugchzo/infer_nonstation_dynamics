...
ax5.text(2, 350/12, r'$\times$', ha='center', va='center', fontsize=40)
...
ax6.text(2, 1.2/12, r'$\times$', ha='center', va='center', fontsize=40)
...
ax8.text(2, 150/12, r'$\times$', ha='center', va='center', fontsize=40)
ax8.text(3, 150/12, r'$\times$', ha='center', va='center', fontsize=40)
...
ax9.text(2, 0.015/12, r'$\times$', ha='center', va='center', fontsize=40)
ax9.text(3, 0.015/12, r'$\times$', ha='center', va='center', fontsize=40)
...
plt.subplots_adjust(top=0.85, bottom=0.03, left=0.05, right=0.98, hspace=0.6, wspace=0.4)

fig.text(0.5, 0.92, 'Degree-4 basis function library', ha='center', va='center',fontsize=25,fontname='Arial',color='navy')
fig.text(0.5, 0.6, 'Degree-5 basis function library', ha='center', va='center',fontsize=25,fontname='Arial',color='navy')
fig.text(0.5, 0.29, 'Degree-6 basis function library', ha='center', va='center',fontsize=25,fontname='Arial',color='navy')
...
legend_nobif = mlines.Line2D([], [], color='black', marker=r'$\times$', linestyle='None', markersize=20)

fig.legend(handles = [legend_v, legend_nobif, legend_p, legend_t],
            labels = ['\u2460  Optimal driving variable', 'No bifurcation','\u2461  Forcing parameters','\u2462  Time variable'],
