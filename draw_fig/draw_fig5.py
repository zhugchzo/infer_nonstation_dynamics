...
# 读取 PDF
bg = PdfReader('../figures/FIG5.0.pdf')
ol_a1 = PdfReader('../figures/FIG5.a1.pdf')
ol_b1 = PdfReader('../figures/FIG5.b1.pdf')
ol_c1 = PdfReader('../figures/FIG5.c1.pdf')
...
with open('../figures/FIG5.pdf', 'wb') as f:
    writer.write(f)
