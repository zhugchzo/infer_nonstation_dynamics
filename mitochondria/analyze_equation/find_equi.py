...
df_data = pd.read_csv('../../results/mitochondria/mitochondria_gen.csv')
df_W_out = pd.read_csv('../../results/mitochondria/mitochondria_W_out.csv')
...
s, info_dict = spi.odeint(f, s0, t, args=(p0,f0),
                            full_output=True,
                            hmin=1e-14,
                            mxhnil=0) # solve the equation with 50000 steps

# Put into pandas
df_traj = pd.DataFrame(s, index=t, columns=['x'])
