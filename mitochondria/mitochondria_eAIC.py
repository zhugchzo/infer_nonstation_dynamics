...
AIC_out.to_csv('../results/mitochondria/mitochondria_AIC.csv', index_label='')
...
dic_W_out.to_csv('../results/mitochondria/mitochondria_W_out.csv',header=True,index=False)
...
pred_out.to_csv('../results/mitochondria/mitochondria_pred.csv',header = True, index=False)
...
gen_out.to_csv('../results/mitochondria/mitochondria_gen.csv',header = True, index=False)
